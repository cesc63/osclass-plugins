CREATE TABLE /*TABLE_PREFIX*/t_market_files (
    ...
    b_enabled TINYINT(1) NOT NULL DEFAULT FALSE,
        ...
        PRIMARY KEY (pk_i_id),
        CONSTRAINT oc_t_market_files_ibfk_1 FOREIGN KEY (fk_i_item_id) REFERENCES /*TABLE_PREFIX*/t_item (pk_i_id)
...
CREATE TABLE /*TABLE_PREFIX*/t_market_stats (
    ...
    dt_date DATETIME NOT NULL,
        ...
        CONSTRAINT oc_t_market_stats_ibfk_1 FOREIGN KEY (fk_i_market_id) REFERENCES /*TABLE_PREFIX*/t_market_files (pk_i_id)
) ENGINE=InnoDB DEFAULT CHARACTER SET 'UTF8' COLLATE 'UTF8_GENERAL_CI';
